...
most_eff <- efficiency %>% 
  ...
  select(-sat_part_rank, -act_part_rank, -ap_part_rank, -ap_score_rank, -act_comp_rank, -sat_comp_rank, -`Spend Percentile Rank`, -bachelor, -doctor, -master, -admin, -teacher, -enrollment, -`Efficiency Index`, -comp_index, -part_index, -`Composite Percentile Rank`, -`Participation Percentile Rank`) %>% 
  select(1:22)
...
write_rds(most_eff, "CA_EDUC_Data/top3.rds")
```
