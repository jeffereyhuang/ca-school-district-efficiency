...
# debug ft_teacher and ft_admin data
...
add_staff <- staff %>% 
  ...
  summarize(avg_t_age = mean(age), t_exp = mean(years_teaching), dist_exp = mean(years_in_district), ft_teacher = sum(fte_teaching == 100),  ft_admin=sum(fte_administrative == 100, fte_pupil_services == 100), num_staff = n()) %>% 
  mutate(ft_teacher = ft_teacher / 100, ft_admin = ft_admin / 100)
